...
tf.random.set_seed(1234) # tf api changed since 2.0

#import tensorflow.contrib.slim as slim
import tf_slim as slim # contrib no longer exists since tf 2.0
...
tf.random.set_seed(my_seed) # api changed after tf 2.0
